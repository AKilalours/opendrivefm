...
if not Path(CKPT).exists():
    CKPT = "artifacts/checkpoints_v9/best_val_ade.ckpt"
...
def main():
    ...
    while True:
        ...
        gt_occ=None
        if current_token:
            for ldir in ["artifacts/nuscenes_labels",
                         "artifacts/nuscenes_labels_128"]:
        ...
        for i,(p,m,c) in enumerate([
            ...
            ("Cam4DOcc CVPR24","binary no-traj 10FPS",(80,180,180)),
